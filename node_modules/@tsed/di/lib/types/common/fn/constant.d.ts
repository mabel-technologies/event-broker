 ...
 * @public
 */
export declare function constant<Type>(expression: string): Type | undefined;
export declare function constant<Type>(expression: string, defaultValue: Type | undefined): Type;
